...
public class WebPushService {
    ...
    public void sendNotification(PushSubscription subscription, PushNotificationPayload payload) {
        try {
            ...
            if (statusCode == 404 || statusCode == 410) {
                ...
                log.warn("Subscription push disattivata perché non più valida. ID: {}", subscription.getId());
                return;
            }
